...
export const STARTING_MONEY = 24;
...
export const SEEDS = [
  ...
  },
  {
    ...
    matureValue: 78,
    oldValue: 30,
    stageScale: [0.52, 0.56, 0.6, 0.78, 0.86],
    traits: { quick: 0.24 },
  ...
  },
  {
    ...
    matureValue: 250,
    oldValue: 95,
    stageScale: [0.62, 0.7, 0.78, 0.92, 1.0],
...
export const SEED_DEMAND_GROWTH_BASE = 1.05;
export const SEED_DEMAND_HALF_LIFE_MS = 2.75 * 60 * 1000;
export const SEED_DEMAND_PER_PLANT = 0.55;
...
export const PRESTIGE_BASE_MONEY = 900;
export const PRESTIGE_COST_GROWTH = 1.34;
...
export const FARM_EXPANSIONS = [
  ...
  { size: 5, reqPrestige: 1, unlockShards: 6 },
  { size: 7, reqPrestige: 2, unlockShards: 20 },
  { size: 8, reqPrestige: 3, unlockShards: 55 },
  { size: 9, reqPrestige: 4, unlockShards: 120 },
  { size: 10, reqPrestige: 5, unlockShards: 300 },
];
