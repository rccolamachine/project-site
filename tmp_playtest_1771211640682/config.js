...
export const SEEDS = [
  ...
  },
  {
    ...
    matureValue: 84,
    oldValue: 34,
    stageScale: [0.6, 0.64, 0.68, 0.8, 0.88],
    traits: { quick: 0.24 },
  ...
  },
  {
    ...
    matureValue: 300,
    oldValue: 120,
    stageScale: [0.72, 0.78, 0.84, 0.96, 1.04],
  ...
  },
  {
    ...
    matureValue: 700,
    oldValue: 280,
    stageScale: [0.84, 0.9, 0.98, 1.12, 1.2],
  ...
  },
  {
    ...
    matureValue: 1250,
    oldValue: 500,
    stageScale: [0.96, 1.04, 1.14, 1.3, 1.38],
...
export const AUTOMATION_COSTS = {
  ...
  autoPlant: 3900,
  autoHarvest: 6200,
  autoEverything: 26000,
};

export const SEED_UNLOCK_ORDER = SEEDS.map((s) => s.id);
export const SOIL_DECAY_MS = 30 * 60 * 1000;
export const SEED_DEMAND_GROWTH_BASE = 1.08;
export const SEED_DEMAND_HALF_LIFE_MS = 4 * 60 * 1000;
export const SEED_DEMAND_PER_PLANT = 1;
export const SEED_DEMAND_MAX_MULTIPLIER = 8;
...
export const PRESTIGE_BASE_MONEY = 1100;
export const PRESTIGE_COST_GROWTH = 1.4;
export const MARKETING_UNLOCK_MONEY = 1100;
export const RESEARCH_UNLOCK_MARKETING = 1;
export const PRESTIGE_START_MONEY_PER_LEVEL = 18;
export const PRESTIGE_GROWTH_SPEED_PER_LEVEL = 0.05;
...
export const ANIMAL_PRESTIGE_OFFSET = 2;
export const FARM_EXPANSIONS = [
  { size: 3, reqPrestige: 0, unlockShards: 0 },
  { size: 5, reqPrestige: 1, unlockShards: 8 },
  { size: 7, reqPrestige: 2, unlockShards: 28 },
  { size: 8, reqPrestige: 3, unlockShards: 80 },
  { size: 9, reqPrestige: 4, unlockShards: 170 },
  { size: 10, reqPrestige: 5, unlockShards: 420 },
];
...
export const MARKET_ROTATION_MS = 12 * 60 * 1000;
