...
Generated: 2026-02-18T23:50:46.883Z
Scope: 100 molecules
Found: 12
Coverage: 12%
...
- mol-0074 | C2H3P isomer 3 | C2H3P | T=686K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":0,"P":1,"O":0,"N":0,"C":2,"H":3} | events=1 | steps=3 | hitRate=0.2 | avgHitS=0.067
...
- mol-0079 | CH2N2S isomer 1 | CH2N2S | T=684K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":1,"P":0,"O":0,"N":2,"C":1,"H":2} | events=0 | steps=2 | hitRate=0.143 | avgHitS=0.267
  1. T: 684, D: 0.9890, B: 3.23, V: 5.14
  2. Add C, H x2, N x2, S (random spawn positions).
- mol-0080 | CH2O3 | CH2O3 | T=684K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":0,"P":0,"O":3,"N":0,"C":1,"H":2} | events=1 | steps=3 | hitRate=0.143 | avgHitS=0.067
  1. T: 684, D: 0.9890, B: 3.23, V: 5.14
...
- mol-0087 | CH3OP isomer 2 | CH3OP | T=686K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":0,"P":1,"O":1,"N":0,"C":1,"H":3} | events=2 | steps=4 | hitRate=0.143 | avgHitS=0.4
  1. T: 686, D: 0.9890, B: 3.23, V: 5.14
  2. Add C, H x3, O, P (random spawn positions).
  3. At ~14%: add C x2, O x2, P x2.
  4. At ~52%: add H x8.
...
- mol-0110 | CHNO3 | CHNO3 | T=802K | damp=0.9911 | bond=3.78 | box=5.39 | spawn={"S":0,"P":0,"O":3,"N":1,"C":1,"H":1} | events=1 | steps=3 | hitRate=0.143 | avgHitS=0.6
  1. T: 802, D: 0.9911, B: 3.78, V: 5.39
  2. Add C, H, N, O x3 (random spawn positions).
  3. At ~24%: add C x2, H x4, O.
- mol-0114 | H2N2O2 isomer 3 | H2N2O2 | T=684K | damp=0.9908 | bond=3.43 | box=5.39 | spawn={"S":0,"P":0,"O":24,"N":24,"C":0,"H":24} | events=0 | steps=2 | hitRate=0.286 | avgHitS=6.5
  1. T: 684, D: 0.9908, B: 3.43, V: 5.39
  2. Add H x24, N x24, O x24 (random spawn positions).
...
- mol-0117 | C3H3P isomer 1 | C3H3P | T=786K | damp=0.9898 | bond=3.66 | box=5.28 | spawn={"S":0,"P":1,"O":0,"N":0,"C":3,"H":3} | events=2 | steps=4 | hitRate=0.2 | avgHitS=4.133
  1. T: 786, D: 0.9898, B: 3.66, V: 5.28
  2. Add C x3, H x3, P (random spawn positions).
  3. At ~14%: add C x6, P x2.
  4. At ~52%: add H x11.
...
- mol-0188 | C4H4 isomer 1 | C4H4 | T=768K | damp=0.9902 | bond=3.74 | box=5.42 | spawn={"S":0,"P":0,"O":0,"N":0,"C":4,"H":4} | events=3 | steps=5 | hitRate=0.143 | avgHitS=0.067
  1. T: 768, D: 0.9902, B: 3.74, V: 5.42
...
- mol-0215 | CH4OS2 isomer 2 | CH4OS2 | T=528K | damp=0.9896 | bond=3.04 | box=5.42 | spawn={"S":2,"P":0,"O":1,"N":0,"C":1,"H":4} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 528, D: 0.9896, B: 3.04, V: 5.42
  2. Add C, H x4, O, S x2 (random spawn positions).
- mol-0218 | CH5NO isomer 2 | CH5NO | T=530K | damp=0.9896 | bond=3.04 | box=5.42 | spawn={"S":0,"P":0,"O":1,"N":1,"C":1,"H":5} | events=1 | steps=3 | hitRate=0.143 | avgHitS=0.067
...
- mol-0238 | CH3N3S isomer 2 | CH3N3S | T=766K | damp=0.992 | bond=3.94 | box=5.67 | spawn={"S":1,"P":0,"O":0,"N":3,"C":1,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 766, D: 0.9920, B: 3.94, V: 5.67
  2. Add C, H x3, N x3, S (random spawn positions).
- mol-0240 | C2H4O2 isomer 2 | C2H4O2 | T=648K | damp=0.9917 | bond=3.59 | box=5.67 | spawn={"S":0,"P":0,"O":2,"N":0,"C":2,"H":4} | events=1 | steps=3 | hitRate=0.143 | avgHitS=6.8
  1. T: 648, D: 0.9917, B: 3.59, V: 5.67
  2. Add C x2, H x4, O x2 (random spawn positions).
  3. At ~60%: add H x11.
- mol-0241 | C2H5N isomer 4 | C2H5N | T=650K | damp=0.9917 | bond=3.59 | box=5.67 | spawn={"S":0,"P":0,"O":0,"N":1,"C":2,"H":5} | events=1 | steps=3 | hitRate=0.286 | avgHitS=31.367
  1. T: 650, D: 0.9917, B: 3.59, V: 5.67
  2. Add C x2, H x5, N (random spawn positions).
  3. At ~60%: add H x8.
- mol-0243 | CH4N2O | CH4N2O | T=648K | damp=0.9917 | bond=3.59 | box=5.67 | spawn={"S":0,"P":0,"O":1,"N":2,"C":1,"H":4} | events=0 | steps=2 | hitRate=0.143 | avgHitS=0.2
  1. T: 648, D: 0.9917, B: 3.59, V: 5.67
