...
Generated: 2026-02-18T23:03:02.184Z
Scope: 100 molecules
Found: 18
Coverage: 18%
...
- mol-0033 | C2NP | C2NP | T=960K | damp=0.9905 | bond=3.97 | box=5.11 | spawn={"S":0,"P":1,"O":0,"N":1,"C":2,"H":0} | events=0 | steps=2 | hitRate=0.2 | avgHitS=2.467
  1. T: 960, D: 0.9905, B: 3.97, V: 5.11
  2. Add C x2, N, P (random spawn positions).
- mol-0049 | H2NPS | H2NPS | T=704K | damp=0.9885 | bond=3.15 | box=5 | spawn={"S":1,"P":1,"O":0,"N":1,"C":0,"H":2} | events=1 | steps=3 | hitRate=0.143 | avgHitS=0.067
  1. T: 704, D: 0.9885, B: 3.15, V: 5.00
  2. Add H x2, N, P, S (random spawn positions).
  3. At ~60%: add H x8.
- mol-0074 | C2H3P isomer 3 | C2H3P | T=686K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":0,"P":1,"O":0,"N":0,"C":2,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
...
- mol-0079 | CH2N2S isomer 1 | CH2N2S | T=684K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":1,"P":0,"O":0,"N":2,"C":1,"H":2} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 684, D: 0.9890, B: 3.23, V: 5.14
  2. Add C, H x2, N x2, S (random spawn positions).
- mol-0080 | CH2O3 | CH2O3 | T=684K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":0,"P":0,"O":3,"N":0,"C":1,"H":2} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 684, D: 0.9890, B: 3.23, V: 5.14
  2. Add C, H x2, O x3 (random spawn positions).
...
- mol-0087 | CH3OP isomer 2 | CH3OP | T=686K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":0,"P":1,"O":1,"N":0,"C":1,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 686, D: 0.9890, B: 3.23, V: 5.14
  2. Add C, H x3, O, P (random spawn positions).
- mol-0089 | CH3PS | CH3PS | T=686K | damp=0.989 | bond=3.23 | box=5.14 | spawn={"S":1,"P":1,"O":0,"N":0,"C":1,"H":3} | events=1 | steps=3 | hitRate=0.143 | avgHitS=0.267
  1. T: 686, D: 0.9890, B: 3.23, V: 5.14
  2. Add C, H x3, P, S (random spawn positions).
  3. At ~60%: add H x8.
...
- mol-0103 | C2H3N isomer 4 | C2H3N | T=806K | damp=0.9911 | bond=3.78 | box=5.39 | spawn={"S":0,"P":0,"O":0,"N":1,"C":2,"H":3} | events=1 | steps=3 | hitRate=0.286 | avgHitS=1.533
  1. T: 806, D: 0.9911, B: 3.78, V: 5.39
  2. Add C x2, H x3, N (random spawn positions).
  3. At ~60%: add H x8.
- mol-0104 | C2H3P isomer 4 | C2H3P | T=806K | damp=0.9911 | bond=3.78 | box=5.39 | spawn={"S":0,"P":1,"O":0,"N":0,"C":2,"H":3} | events=2 | steps=4 | hitRate=0.143 | avgHitS=0.4
  1. T: 806, D: 0.9911, B: 3.78, V: 5.39
  2. Add C x2, H x3, P (random spawn positions).
  3. At ~14%: add C x4, P x2.
  4. At ~52%: add H x8.
...
- mol-0110 | CHNO3 | CHNO3 | T=802K | damp=0.9911 | bond=3.78 | box=5.39 | spawn={"S":0,"P":0,"O":3,"N":1,"C":1,"H":1} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 802, D: 0.9911, B: 3.78, V: 5.39
  2. Add C, H, N, O x3 (random spawn positions).
- mol-0114 | H2N2O2 isomer 3 | H2N2O2 | T=684K | damp=0.9908 | bond=3.43 | box=5.39 | spawn={"S":0,"P":0,"O":2,"N":2,"C":0,"H":2} | events=0 | steps=2 | hitRate=0 | avgHitS=-
...
- mol-0117 | C3H3P isomer 1 | C3H3P | T=786K | damp=0.9898 | bond=3.66 | box=5.28 | spawn={"S":0,"P":1,"O":0,"N":0,"C":3,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 786, D: 0.9898, B: 3.66, V: 5.28
...
- mol-0119 | C3H3P isomer 3 | C3H3P | T=786K | damp=0.9898 | bond=3.66 | box=5.28 | spawn={"S":0,"P":1,"O":0,"N":0,"C":3,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 786, D: 0.9898, B: 3.66, V: 5.28
  2. Add C x3, H x3, P (random spawn positions).
- mol-0122 | C2H3NO isomer 2 | C2H3NO | T=666K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":0,"P":0,"O":1,"N":1,"C":2,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
...
- mol-0123 | C2H3NO isomer 3 | C2H3NO | T=666K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":0,"P":0,"O":1,"N":1,"C":2,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 666, D: 0.9894, B: 3.31, V: 5.28
  2. Add C x2, H x3, N, O (random spawn positions).
- mol-0124 | C2H3NS isomer 1 | C2H3NS | T=666K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":1,"P":0,"O":0,"N":1,"C":2,"H":3} | events=2 | steps=4 | hitRate=0.2 | avgHitS=0.067
  1. T: 666, D: 0.9894, B: 3.31, V: 5.28
  2. Add C x2, H x3, N, S (random spawn positions).
  3. At ~14%: add C x4, N x2, S x2.
  4. At ~52%: add H x11.
...
- mol-0129 | C3H4 isomer 2 | C3H4 | T=668K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":0,"P":0,"O":0,"N":0,"C":3,"H":4} | events=3 | steps=5 | hitRate=0.2 | avgHitS=0.267
  1. T: 668, D: 0.9894, B: 3.31, V: 5.28
  2. Add C x3, H x4 (random spawn positions).
  3. At ~16%: add C x6.
...
- mol-0133 | CH3NOS isomer 1 | CH3NOS | T=666K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":1,"P":0,"O":1,"N":1,"C":1,"H":3} | events=3 | steps=5 | hitRate=0.2 | avgHitS=0.067
  1. T: 666, D: 0.9894, B: 3.31, V: 5.28
  2. Add C, H x3, N, O, S (random spawn positions).
  3. At ~10%: add C, N, O, S.
  4. At ~30%: add C x2, N x2, O x2, S x2.
  5. At ~64%: add H x11.
...
- mol-0142 | CH3OPS | CH3OPS | T=666K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":1,"P":1,"O":1,"N":0,"C":1,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 666, D: 0.9894, B: 3.31, V: 5.28
...
- mol-0144 | CH4N2 isomer 1 | CH4N2 | T=668K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":0,"P":0,"O":0,"N":2,"C":1,"H":4} | events=0 | steps=2 | hitRate=0.143 | avgHitS=0.067
  1. T: 668, D: 0.9894, B: 3.31, V: 5.28
  2. Add C, H x4, N x2 (random spawn positions).
- mol-0147 | CH4NP isomer 2 | CH4NP | T=668K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":0,"P":1,"O":0,"N":1,"C":1,"H":4} | events=1 | steps=3 | hitRate=0.143 | avgHitS=0.067
  1. T: 668, D: 0.9894, B: 3.31, V: 5.28
  2. Add C, H x4, N, P (random spawn positions).
  3. At ~24%: add C x2, H x4.
- mol-0149 | CH4NP isomer 4 | CH4NP | T=668K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":0,"P":1,"O":0,"N":1,"C":1,"H":4} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 668, D: 0.9894, B: 3.31, V: 5.28
  2. Add C, H x4, N, P (random spawn positions).
- mol-0150 | CH4P2 | CH4P2 | T=668K | damp=0.9894 | bond=3.31 | box=5.28 | spawn={"S":0,"P":2,"O":0,"N":0,"C":1,"H":4} | events=2 | steps=4 | hitRate=0.143 | avgHitS=0.067
  1. T: 668, D: 0.9894, B: 3.31, V: 5.28
  2. Add C, H x4, P x2 (random spawn positions).
  3. At ~14%: add C x2, P x4.
  4. At ~52%: add H x8.
- mol-0152 | CH4O2 isomer 2 | CH4O2 | T=548K | damp=0.9891 | bond=2.96 | box=5.28 | spawn={"S":0,"P":0,"O":20,"N":0,"C":10,"H":40} | events=3 | steps=5 | hitRate=0.429 | avgHitS=17.733
  1. T: 548, D: 0.9891, B: 2.96, V: 5.28
  2. Add C x10, H x40, O x20 (random spawn positions).
  3. At ~16%: add C x2, O x4.
  4. At ~48%: delete ~35% of H atoms.
  5. At ~64%: add H x8.
- mol-0155 | CH4S2 isomer 1 | CH4S2 | T=548K | damp=0.9891 | bond=2.96 | box=5.28 | spawn={"S":2,"P":0,"O":0,"N":0,"C":1,"H":4} | events=1 | steps=3 | hitRate=0.429 | avgHitS=23.689
  1. T: 548, D: 0.9891, B: 2.96, V: 5.28
  2. Add C, H x4, S x2 (random spawn positions).
  3. At ~60%: add H x8.
- mol-0156 | CH4S2 isomer 2 | CH4S2 | T=548K | damp=0.9891 | bond=2.96 | box=5.28 | spawn={"S":2,"P":0,"O":0,"N":0,"C":1,"H":4} | events=1 | steps=3 | hitRate=0.143 | avgHitS=8
  1. T: 548, D: 0.9891, B: 2.96, V: 5.28
  2. Add C, H x4, S x2 (random spawn positions).
  3. At ~24%: add C x2, H x4, S.
...
- mol-0166 | C2H3NO isomer 4 | C2H3NO | T=786K | damp=0.9916 | bond=3.86 | box=5.53 | spawn={"S":0,"P":0,"O":1,"N":1,"C":2,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  ...
  2. Add C x2, H x3, N, O (random spawn positions).
- mol-0167 | C2H3NO isomer 5 | C2H3NO | T=786K | damp=0.9916 | bond=3.86 | box=5.53 | spawn={"S":0,"P":0,"O":1,"N":1,"C":2,"H":3} | events=0 | steps=2 | hitRate=0.143 | avgHitS=1.667
  1. T: 786, D: 0.9916, B: 3.86, V: 5.53
  2. Add C x2, H x3, N, O (random spawn positions).
...
- mol-0174 | C3H3N isomer 3 | C3H3N | T=786K | damp=0.9916 | bond=3.86 | box=5.53 | spawn={"S":0,"P":0,"O":0,"N":1,"C":3,"H":3} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 786, D: 0.9916, B: 3.86, V: 5.53
  2. Add C x3, H x3, N (random spawn positions).
- mol-0175 | C3H3N isomer 4 | C3H3N | T=786K | damp=0.9916 | bond=3.86 | box=5.53 | spawn={"S":0,"P":0,"O":0,"N":1,"C":3,"H":3} | events=0 | steps=2 | hitRate=0.143 | avgHitS=12.6
  1. T: 786, D: 0.9916, B: 3.86, V: 5.53
  2. Add C x3, H x3, N (random spawn positions).
...
- mol-0180 | C2H4S isomer 2 | C2H4S | T=668K | damp=0.9912 | bond=3.51 | box=5.53 | spawn={"S":1,"P":0,"O":0,"N":0,"C":2,"H":4} | events=1 | steps=3 | hitRate=0.571 | avgHitS=20.483
  1. T: 668, D: 0.9912, B: 3.51, V: 5.53
  2. Add C x2, H x4, S (random spawn positions).
  3. At ~60%: add H x8.
- mol-0181 | CH3NO2 isomer 3 | CH3NO2 | T=666K | damp=0.9912 | bond=3.51 | box=5.53 | spawn={"S":0,"P":0,"O":2,"N":1,"C":1,"H":3} | events=1 | steps=3 | hitRate=0.286 | avgHitS=4
  1. T: 666, D: 0.9912, B: 3.51, V: 5.53
  2. Add C, H x3, N, O x2 (random spawn positions).
  3. At ~60%: add H x11.
...
- mol-0188 | C4H4 isomer 1 | C4H4 | T=768K | damp=0.9902 | bond=3.74 | box=5.42 | spawn={"S":0,"P":0,"O":0,"N":0,"C":4,"H":4} | events=0 | steps=2 | hitRate=0 | avgHitS=-
  1. T: 768, D: 0.9902, B: 3.74, V: 5.42
