...
export const STAGES = [
  ...
  { id: "seedling", label: "Seedling", durationMs: 60 * 1000 },
  { id: "young", label: "Young Plant", durationMs: 4 * 60 * 1000 },
  { id: "mature", label: "Mature Plant", durationMs: 10 * 60 * 1000 },
  { id: "old", label: "Old Plant", durationMs: 24 * 60 * 1000 },
];
...
export const SEEDS = [
  {
    ...
    stageScale: [0.22, 0.14, 0.1, 1.0, 1.08],
  ...
  },
  {
    ...
    traits: { jackpot: 0.28, matureBonus: 0.34 },
...
export const SEED_DEMAND_HALF_LIFE_MS = 2.2 * 60 * 1000;
export const SEED_DEMAND_PER_PLANT = 0.36;
...
export const PRESTIGE_BASE_MONEY = 2200;
export const PRESTIGE_COST_GROWTH = 1.33;
export const MARKETING_UNLOCK_MONEY = 1400;
export const RESEARCH_UNLOCK_MARKETING = 2;
export const PRESTIGE_START_MONEY_PER_LEVEL = 44;
export const PRESTIGE_GROWTH_SPEED_PER_LEVEL = 0.06;
export const PRESTIGE_MAX_GROWTH_SPEED = 0.6;
export const HOUSE_GOAL_MONEY = 100_000_000;
export const SECOND_HOUSE_GOAL_MONEY = 200_000_000;
...
export const FARM_EXPANSIONS = [
  { size: 1, reqPrestige: 0, unlockMoney: 0, unlockShards: 0 },
  { size: 2, reqPrestige: 0, unlockMoney: 200, unlockShards: 0 },
  { size: 3, reqPrestige: 0, unlockMoney: 1200, unlockShards: 0 },
  { size: 4, reqPrestige: 1, unlockShards: 4 },
  { size: 5, reqPrestige: 2, unlockShards: 13 },
  { size: 7, reqPrestige: 3, unlockShards: 38 },
  { size: 8, reqPrestige: 4, unlockShards: 82 },
  { size: 9, reqPrestige: 5, unlockShards: 205 },
  { size: 10, reqPrestige: 6, unlockShards: 500 },
];
...
export const MARKET_ROTATION_MS = 6 * 60 * 1000;
